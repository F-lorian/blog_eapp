...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 03 Décembre 2015 à 15:42
...
INSERT INTO `blog` (`id`, `id_user`, `name`, `theme`, `url_alias`, `description`) VALUES
(4, 7, 'Blog de la fac', 'informations', 'master2-info-um2', 'blog d''informations des masters 2 informatique de l''UM2'),
(13, 7, 'test', 'test thème', 'test-url', 'test description');
...
(11, 'HMIN310', 4),
(12, 'HMIN311', 4),
(16, 'azraf-df-sdf-sdf--h-h-hhhhgh-hhfghgfhf-ghd', 4),
(17, 'general', NULL),
(21, 'AZRT', 4),
...
INSERT INTO `fos_user` (`id`, `username`, `username_canonical`, `email`, `email_canonical`, `enabled`, `salt`, `password`, `last_login`, `locked`, `expired`, `expires_at`, `confirmation_token`, `password_requested_at`, `roles`, `credentials_expired`, `credentials_expire_at`, `surname`, `lastname`, `age`) VALUES
(7, 'test', 'test', 'test@test.com', 'test@test.com', 1, '7qny3t74n7k0ws0c4g8occ0cosw8kos', '$2y$13$7qny3t74n7k0ws0c4g8ocOlnORzBDptbm9tJEyhve/qD9ClsbZf.e', '2015-12-03 15:37:22', 0, 0, NULL, NULL, NULL, 'a:0:{}', 0, NULL, 'test prénom', 'test nom', 12);
